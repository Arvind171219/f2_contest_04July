  ...
  function displayStudents() {
    ...
    students.forEach(student => {
      ...
      row.innerHTML = `
        ...
        <td>${student.email}</td>
        <td><button onclick="editStudent(${student.ID})"><i class="fa-sharp fa-solid fa-pen-to-square"></button></td>
        <td><button onclick="deleteStudent(${student.ID})"><i class="fa-solid fa-trash"></i></button></td>
      `;
